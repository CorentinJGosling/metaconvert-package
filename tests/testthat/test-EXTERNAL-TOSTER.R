...
# ==============================================================================
# For two-group designs, metaConvert computes within-group d_rm separately
# then subtracts. TOSTER only computes single-group, so we replicate the
# two-group logic manually.

test_that("Two-group d_rm: metaConvert matches TOSTER-based manual calculation", {
  skip_if_not(has_TOSTER, "TOSTER not available")
  skip_if_not(has_MASS, "MASS not available")
...
test_that("convert_df with morris_drm matches TOSTER for full pipeline", {
  skip_if_not(has_TOSTER, "TOSTER not available")
  skip_if_not(has_MASS, "MASS not available")
