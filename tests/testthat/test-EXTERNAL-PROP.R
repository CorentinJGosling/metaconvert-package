...
#   - 1e-10: Freeman-Tukey ES against metafor PFT (exact match)
#   - 1e-10: Freeman-Tukey SE against metafor PFT (exact match, both use 1/sqrt(4n+2))
#
# =============================================================================
...
# -----------------------------------------------------------------------------
test_that("PROP-EDGE: zero prevalence matches metafor PLO + PFT", {
  zero_cases <- c(0, 0, 0)
  zero_ns <- c(50, 100, 200)
...
# -----------------------------------------------------------------------------
test_that("PROP-EDGE: full prevalence matches metafor PLO + PFT", {
  full_ns <- c(50, 100, 200)
  full_cases <- full_ns  # 100% prevalence
