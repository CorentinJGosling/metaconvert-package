...
# Adapted to the phase-1 P13 fix: on a clamped (extreme) disattenuation row,
# ALL Fisher-z outputs are now NA (the archived file expected a finite,
# bounded z — that artifact has been removed).
# =============================================================================
...
# ==============================================================================
# Disattenuation — corrected-r CI is the back-transformed Fisher-z interval,
...
test_that("es_disattenuate NAs the r CI AND the z outputs when the corrected r is extreme (>1)", {
  ...
  # P13: the z columns are no longer a finite clamp artifact — they are NA too
